...
export default function TestSalve({ eleves, setEleves }) {
    ...
    return (
      <div className="bg-piste-panneau rounded-xl border border-white/10 p-6 text-center mb-6">
        ...
        <div className="flex items-center justify-center gap-3 flex-wrap">
          ...
          >
            <Square size={14} /> Terminer la salve
          </button>
          <button onClick={annulerSalve} className="text-piste-craie/40 hover:text-piste-brique text-sm flex items-center gap-1">
    ...
    return (
      <div className="bg-piste-panneau rounded-xl border border-white/10 p-5 mb-6">
        ...
        <p className="text-xs text-piste-craie/40 mb-4">
          {arrivals.length} arrivée(s) enregistrée(s) sur cette salve, du plus rapide au plus lent. Choisis le nom
          de chaque élève.
        </p>
        ...
        <div className="flex gap-3">
          ...
          <button onClick={annulerSalve} className="text-piste-craie/40 hover:text-piste-brique text-sm">
            Annuler cette salve
          </button>
        </div>
      </div>
  ...
  return (
    <div className="bg-piste-panneau rounded-xl border border-white/10 p-5 mb-6">
      ...
      <p className="text-xs text-piste-craie/40 mb-4">
        ...
        l'eau, et tu identifies les élèves une fois la salve terminée.
      </p>
      <button
        onClick={demarrer}
      ...
      >
        <Play size={18} /> Départ de la salve
      </button>
    </div>
  );
}
